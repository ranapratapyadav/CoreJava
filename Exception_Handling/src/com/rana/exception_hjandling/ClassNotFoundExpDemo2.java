...
Class loaded successfully: java.lang.String
 */
class ClassNotFoundExpDemo2
{
	public static void main(String[] args)
	{
	    String str=IO.readln("Enter the class: ");
	    ClassNotFoundExpDemo cl=new ClassNotFoundExpDemo(str);
	}
}
...
{
    public ClassNotFoundExpDemo(String clsname)
    {
        Class<?> cl;
        try
        {
            cl=Class.forName(clsname);
            IO.println("Class loaded successfully: "+clsname);
        }
        catch(ClassNotFoundException e)
        {
            IO.println("Error: Class '"+clsname+"' not found.");
        }
    }
}